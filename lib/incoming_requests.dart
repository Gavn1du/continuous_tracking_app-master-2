...
class IncomingPage extends StatefulWidget {
  ...
  @override
  State<IncomingPage> createState() => _IncomingPage();
}

class _IncomingPage extends State<IncomingPage> {
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            DatabaseReference listPush = FirebaseDatabase
                                ...
                                .child("friends/$uid");
                            listPush.update({
                              keys[i].toString(): "true",
                            });
                            listPush = FirebaseDatabase.instance
                                .ref()
                                .child("friends/$alternate");
                            listPush.update({
                              uid.toString(): "true"
                            });
                            Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      IncomingPage()), // this mymainpage is your page to refresh
