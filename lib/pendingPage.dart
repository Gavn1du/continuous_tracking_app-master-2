      ...
      body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
                      ...
                      children: [
                        IconButton(
                            onPressed: () {
                              ...
                              listPush = FirebaseDatabase
                                  .instance
                                  .ref()
                                  .child("friends/$newKey");
                              listPush.update({
                                uid.toString(): "cancelled",
                              });
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        PendingPage()), // this mymainpage is your page to refresh
              ...
              return Scaffold(
                appBar: AppBar(
                  title: const Text('Requests You Sent'),
